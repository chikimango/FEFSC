...
# How to Use
The program is relatively straightforward if you already have previous knowledge on how to code supports, but I'll be explaining how FESC works below. [Here's](http://pastebin.com/0g7jf3i3) a guide on coding supports if you'd like more information about that.
